...
set(DEX_PROJECT_NAME "swapcase-desktop")
set(DEX_DISPLAY_NAME "Swapcase Desktop")
set(DEX_MAINTENANCE_TOOL_NAME "Swapcase Maintenance Tool")
set(DEX_COMPANY "Swapcase")
...
set(DEX_REPOSITORY_NAME "Swapcase-Desktop")
set(DEX_CHECKSUM_API_URL "https://komodo.live/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "Swapcase Desktop")
else ()
    set(DEX_APPDATA_FOLDER "swapcase_qt")
endif ()
